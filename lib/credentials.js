...
let keyFile;
try {
  keyFile = require("../resources/keys.json"); //eslint-disable-line global-require
} catch (err) {
  keyFile = {};
  logger.warn(
    "No resources/key.json file found, using default (and insecure) credentials!"
  );
}
...
module.exports = Object.assign(
  ...
  keyFile
); //use data from file first if any found
