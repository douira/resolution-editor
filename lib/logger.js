...
//make this logger's .error print the first two args to the console in dev mode
if (devEnv) {
  //get loggign fucntion
  const origLogger = logger.error;
  ...
  logger.error = (err, msg) => {
    ...
    origLogger.call(logger, err, msg);
  };
}
