...
const validationParams = {
  contentSuffix: "hgl34d%HöF",
  seed: 656546544976064
};
...
const tokenLib = module.exports = {
  ...
  getValidation: function(forStr, vLength) {
    ...
    let hashNumber = XXH.h32(forStr + validationParams.contentSuffix, validationParams.seed)
      .toNumber();
  ...
  check: function(checkThis) {
    ...
    if (checkThis.length - 1 !== tokenCodeLength) {
      return false;
    }
