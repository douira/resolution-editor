...
function generateSignature(name, position, index, totalNumerOfSignatures ){
    ...
    if(index <= 3){ 
      let str+=`\\draw (${index}*\\strichbreite+${index}*\\luecke,\\erstezeile) -- (${index+1}*\\strichbreite+${index}*\\luecke,\\erstezeile);
      ...
      if(totalNumerOfSignatures == 8){
        let str+=`\\draw (${index}*\\strichbreite+${index}*\\luecke,\\zweitezeile) --  (${index+1}*\\strichbreite+${index}*\\luecke,\\zweitezeile);
        ...
        let str+=`\\draw (${index}*\\strichbreite+${index}*\\luecke+\\offsetsieben,\\zweitezeile) -- (${index+1}*\\strichbreite+${index}*\\luecke+\\offsetsieben,\\zweitezeile);
