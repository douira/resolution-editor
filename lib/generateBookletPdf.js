...
function generateLatexBooklet(booklet) {
  ...
  let str= `\\begin{titlepage}
            ...
            \\node at (0.5*\\strichbreite,\\erstezeile-0.3)[below] {${booklet.signatures[0].name}};
            \\node at (0.5*\\strichbreite,\\erstezeile-1)[below] {(${booklet.signatures[0].position})};
            \\draw (\\strichbreite+\\luecke,\\erstezeile) -- (2*\\strichbreite+\\luecke,\\erstezeile);
            \\node at (1.5*\\strichbreite+\\luecke,\\erstezeile-0.3)[below] {${booklet.signatures[1].name}};
            \\node at (1.5*\\strichbreite+\\luecke,\\erstezeile-1)[below] {(${booklet.signatures[1].position})};
            \\draw (2*\\strichbreite+2*\\luecke,\\erstezeile) -- (3*\\strichbreite+2*\\luecke,\\erstezeile);
            \\node at (2.5*\\strichbreite+2*\\luecke,\\erstezeile-0.3)[below] {${booklet.signatures[2].name}};
            \\node at (2.5*\\strichbreite+2*\\luecke,\\erstezeile-1)[below] {(${booklet.signatures[2].position})};
            \\draw (3*\\strichbreite+3*\\luecke,\\erstezeile) -- (4*\\strichbreite+3*\\luecke,\\erstezeile);
            \\node at (3.5*\\strichbreite+3*\\luecke,\\erstezeile-0.3)[below] {${booklet.signatures[3].name}};
            \\node at (3.5*\\strichbreite+3*\\luecke,\\erstezeile-1)[below] {(${booklet.signatures[3].position})};
            ` 
            
  if(booklet.signatures.count >= 8){
    str +=`\\draw (0,\\zweitezeile) -- (\\strichbreite,\\zweitezeile);
           \\node at (0.5*\\strichbreite,\\zweitezeile-0.3)[below] {${booklet.signatures[4].name}};
           \\node at (0.5*\\strichbreite,\\zweitezeile-1)[below] {(${booklet.signatures[4].position})};
           \\draw (\\strichbreite+\\luecke,\\zweitezeile) -- (2*\\strichbreite+\\luecke,\\zweitezeile);
           \\node at (1.5*\\strichbreite+\\luecke,\\zweitezeile-0.3)[below] {${booklet.signatures[5].name}};
           \\node at (1.5*\\strichbreite+\\luecke,\\zweitezeile-1)[below] {(${booklet.signatures[5].position})};
           \\draw (2*\\strichbreite+2*\\luecke,\\zweitezeile) -- (3*\\strichbreite+2*\\luecke,\\zweitezeile);
           \\node at (2.5*\\strichbreite+2*\\luecke,\\zweitezeile-0.3)[below] {${booklet.signatures[6].name}};
           \\node at (2.5*\\strichbreite+2*\\luecke,\\zweitezeile-1)[below] {(${booklet.signatures[6].position})};
           \\draw (3*\\strichbreite+3*\\luecke,\\zweitezeile) -- (4*\\strichbreite+3*\\luecke,\\zweitezeile);
           \\node at (3.5*\\strichbreite+3*\\luecke,\\zweitezeile-0.3)[below] {${booklet.signatures[7].name}};
           \\node at (3.5*\\strichbreite+3*\\luecke,\\zweitezeile-1)[below] {(${booklet.signatures[7].position})};` 
    ...
    str += `\\def\\offsetsieben{\\strichbreite/2+\\luecke/2}
            ...
            \\node at (0.5*\\strichbreite+\\offsetsieben,\\zweitezeile-0.3)[below] {${booklet.signatures[4].name}};
            \\node at (0.5*\\strichbreite+\\offsetsieben,\\zweitezeile-1)[below] {(${booklet.signatures[4].position})};
            \\draw (\\strichbreite+\\luecke+\\offsetsieben,\\zweitezeile) -- (2*\\strichbreite+\\luecke+\\offsetsieben,\\zweitezeile);
            \\node at (1.5*\\strichbreite+\\luecke+\\offsetsieben,\\zweitezeile-0.3)[below] {${booklet.signatures[5].name}};
            \\node at (1.5*\\strichbreite+\\luecke+\\offsetsieben,\\zweitezeile-1)[below] {(${booklet.signatures[5].name})};
            \\draw (2*\\strichbreite+2*\\luecke+\\offsetsieben,\\zweitezeile) -- (3*\\strichbreite+2*\\luecke+\\offsetsieben,\\zweitezeile);
            \\node at (2.5*\\strichbreite+2*\\luecke+\\offsetsieben,\\zweitezeile-0.3)[below] {${booklet.signatures[6].name}};
            \\node at (2.5*\\strichbreite+2*\\luecke+\\offsetsieben,\\zweitezeile-1)[below] {(${booklet.signatures[6].name})};
            `
  }
            
  for(resDoc in booklet.resolutions){
