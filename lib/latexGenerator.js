...
function prepareClause(str) {
  ...
  return str
    .trim() //remove all spaces at tips
    ...
    //remove special characters that may mess up latex, ^ and _ are used later though (see below)
    .replace(/[#$%&\\{}~]+/g, "")

    //parse special char markers: see issue douira/resolution-editor#104
    //asteriks enclose italics, add the italics mackers
